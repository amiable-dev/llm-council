---
name: kb-link
description: Find isolated or one-way-linked concepts and propose reciprocal cross-links. Use when a concept is unreachable, after promoting a new concept, or when asked to improve connections between notes.
verb: kb link check | suggest | --draft l.json [--apply]
paths: concepts/**
---
