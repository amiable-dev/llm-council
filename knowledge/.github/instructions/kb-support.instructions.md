---
applyTo: "concepts/**, .kb/evidence/**"
---

# kb-support

Judge whether a concept's citations actually support its claims. Use when validating a note's evidence, after revalidate reports drift, or when asked whether a source really backs what the note says.
