---
applyTo: "concepts/**, maintenance/**"
---

# kb-audit

Semantic lint — contradictions, stale claims, concept gaps, graph rot. Use after a batch of promotions, when the corpus feels inconsistent, or on a maintenance pass.
