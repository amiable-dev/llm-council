...
Turn an assessed staging note into one or more concept notes. Use after kb-assess routes to promote or split, or when asked to write up a staged source as a concept.
