...
Classify concepts against the repo's closed facet axes — domain, maturity and source type. Use when notes are unclassified, or when asked to categorise, tag or organise concepts.

`kb facets [--sample N] [--draft f.json] [--apply]`
