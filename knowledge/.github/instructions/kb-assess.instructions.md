...
Judge whether a staged source is worth promoting into a concept, using the repo's promotion rubric. Use after kb-ingest, or when asked whether something is worth keeping, promoting or discarding.

`kb assess <file> [--verdict v.json]`
