...
Compile the exact context a task needs — target notes, binding policy, graph neighbours, prior artifacts — as one deterministic bundle. Use before drafting cards, reviewing a promotion, judging an audit pair, or answering from the corpus.
