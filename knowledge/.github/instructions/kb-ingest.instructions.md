...
Fetch a URL into the knowledge base's staging area as a reviewable source note. Use when the user shares a link, article or repo they want captured, or says to ingest, capture or save a source.
